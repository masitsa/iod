            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url().'logout-admin';?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url().'admin/members';?>"><i class="fa fa-users fa-fw"></i> All Members</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url().'admin/members/import_members';?>"><i class="fa fa-upload fa-fw"></i> Import Members</a>
                                </li>
                            </ul>
                        </li>
                        
                        <li>
                            <a href="<?php echo site_url().'admin/companies';?>"><i class="fa fa-users fa-fw"></i> Companies</a>
                        </li>
