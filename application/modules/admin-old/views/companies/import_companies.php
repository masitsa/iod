<div class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('admin/companies/do_companies_import', array("class" => "form-horizontal", "role" => "form"));?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'admin/companies/import_companies_template';?>">here.</a></li>
                        
                        <li>Save your file as a <strong>CSV (Comma Delimited)</strong> file before importing</li>
                        <li>After adding your companies to the import template please import them using the button below</li>
                    </ul>
                </div>
            </div>
