					...
					<!-- COURSES DETAIL TABS WRAP START -->
	 							<div class="kf_courses_tabs">
									...
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation" class="active"><a href="courses-detail.html#coursedetails" aria-controls="coursedetails" role="tab" data-toggle="tab">UPCOMING EVENTS</a></li>
										<li role="presentation"><a href="courses-detail.html#coursestructure" aria-controls="coursestructure" role="tab" data-toggle="tab">ANNOUNCEMENTS</a></li>
									</ul>
