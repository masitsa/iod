                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="widget megacourse">
                            ...
                            <a href="account-assignment.html#" class="mc-btn btn-style-1">Get started</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="widget quick_link">
                            ...
                            <ul class="list-style-block">
                                <li><a href="account-assignment.html#">About us</a></li>
                                <li><a href="account-assignment.html#">Terms of use</a></li>
                                <li><a href="account-assignment.html#">FAQ</a></li>
                                <li><a href="account-assignment.html#">Support</a></li>
                                <li><a href="account-assignment.html#">Contact</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="contact">
                    <div class="email">
                        ...
                        <a href="account-assignment.html#">course@megadrupal.com</a>
                    </div>
                    <div class="phone">
